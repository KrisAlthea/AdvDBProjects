...
public class SqlParser extends Parser {
	...
	public static final int
		...
		RULE_column_list = 4, RULE_table_name = 5, RULE_condition = 6, RULE_expression = 7;
	private static String[] makeRuleNames() {
		return new String[] {
			"query", "select_clause", "from_clause", "where_clause", "column_list", 
			"table_name", "condition", "expression"
		};
	}
	...
	public static class Column_listContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SqlListener) ((SqlListener)listener).enterColumn_list(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SqlListener) ((SqlListener)listener).exitColumn_list(this);
		}
	}
